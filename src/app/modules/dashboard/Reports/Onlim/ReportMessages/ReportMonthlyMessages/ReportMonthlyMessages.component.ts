...
@Component({
  selector: 'app-ReportMonthlyMessages',
  templateUrl: './ReportMonthlyMessages.component.html',
  styleUrls: ['./ReportMonthlyMessages.component.scss']
})
export class ReportMonthlyMessagesComponent implements OnInit {
  dataMap=[] ;
  range = new FormGroup({
